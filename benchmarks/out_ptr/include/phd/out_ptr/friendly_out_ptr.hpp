...
namespace phd {
	...
	struct friendly_out_ptr_t : public out_ptr_detail::friendly_out_ptr_impl<Smart, Pointer, std::tuple<Args...>, std::make_index_sequence<std::tuple_size_v<std::tuple<Args...>>>> {
	private:
