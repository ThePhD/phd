...
static void int_by_ref_transparent_failure(benchmark::State& state) {
...
static void int_3x_by_ref_transparent_failure(benchmark::State& state) {
	std::size_t expected_value;
	{
		tl::optional<size_t&> maybe_value = tl::nullopt;
...
static void vector_by_ref_transparent_failure(benchmark::State& state) {
	std::size_t expected_value;
	{
...
static void vector_3x_by_ref_transparent_failure(benchmark::State& state) {
	std::size_t expected_value;
	{
		tl::optional<std::vector<size_t>&> maybe_value = tl::nullopt;
		expected_value = bench_transparent_inplace_vector(maybe_value);
...
BENCHMARK(int_by_ref_transparent_failure)
	->ComputeStatistics("max", &compute_max)
	->ComputeStatistics("min", &compute_min)
	->ComputeStatistics("variance", &compute_variance)
	->ComputeStatistics("dispersion", &compute_index_of_dispersion);

BENCHMARK(int_3x_by_ref_transparent_failure)
	->ComputeStatistics("max", &compute_max)
	->ComputeStatistics("min", &compute_min)
	->ComputeStatistics("variance", &compute_variance)
	->ComputeStatistics("dispersion", &compute_index_of_dispersion);

BENCHMARK(vector_by_ref_transparent_failure)
	->ComputeStatistics("max", &compute_max)
	->ComputeStatistics("min", &compute_min)
	->ComputeStatistics("variance", &compute_variance)
	->ComputeStatistics("dispersion", &compute_index_of_dispersion);

BENCHMARK(vector_3x_by_ref_transparent_failure)
	->ComputeStatistics("max", &compute_max)
	->ComputeStatistics("min", &compute_min)
	->ComputeStatistics("variance", &compute_variance)
	->ComputeStatistics("dispersion", &compute_index_of_dispersion);
