...
static void int_by_ref_success(benchmark::State& state) {
	size_t x = 0;
...
static void int_3x_by_ref_success(benchmark::State& state) {
	size_t x = 0;
	size_t expected_value = 0;
	{
		size_t ref_value = int_value;
...
static void vector_by_ref_success(benchmark::State& state) {
...
static void vector_3x_by_ref_success(benchmark::State& state) {
	std::vector<size_t> initial_value = create_random_vector();
...
BENCHMARK(int_by_ref_success)
	->ComputeStatistics("max", &compute_max)
	->ComputeStatistics("min", &compute_min)
	->ComputeStatistics("variance", &compute_variance)
	->ComputeStatistics("dispersion", &compute_index_of_dispersion);

BENCHMARK(int_3x_by_ref_success)
	->ComputeStatistics("max", &compute_max)
	->ComputeStatistics("min", &compute_min)
	->ComputeStatistics("variance", &compute_variance)
	->ComputeStatistics("dispersion", &compute_index_of_dispersion);

BENCHMARK(vector_by_ref_success)
	->ComputeStatistics("max", &compute_max)
	->ComputeStatistics("min", &compute_min)
	->ComputeStatistics("variance", &compute_variance)
	->ComputeStatistics("dispersion", &compute_index_of_dispersion);

BENCHMARK(vector_3x_by_ref_success)
	->ComputeStatistics("max", &compute_max)
	->ComputeStatistics("min", &compute_min)
	->ComputeStatistics("variance", &compute_variance)
	->ComputeStatistics("dispersion", &compute_index_of_dispersion);
