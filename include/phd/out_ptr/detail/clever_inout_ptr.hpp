...
namespace detail {
	...
	class PHD_OUT_PTR_TRIVIAL_ABI clever_inout_ptr_t : public clever_inout_ptr_impl<Smart, Pointer, std::tuple<Args...>, std::make_index_sequence<std::tuple_size<std::tuple<Args...>>::value>> {
	private:
