...
#ifndef PHD_OUT_PTR_OUT_PTR_DETAIL_CLEVER_INOUT_PTR_HPP
#define PHD_OUT_PTR_OUT_PTR_DETAIL_CLEVER_INOUT_PTR_HPP
...
namespace phd::detail {
	...
	class clever_inout_ptr_t : public detail::clever_inout_ptr_impl<Smart, Pointer, std::tuple<Args...>, std::make_index_sequence<std::tuple_size_v<std::tuple<Args...>>>> {
	private:
		using list_t = std::make_index_sequence<std::tuple_size_v<std::tuple<Args...>>>;
		using core_t = detail::clever_inout_ptr_impl<Smart, Pointer, std::tuple<Args...>, list_t>;
...
#endif // PHD_OUT_PTR_OUT_PTR_DETAIL_CLEVER_INOUT_PTR_HPP
