...
#ifndef PHD_TESTS_BASIC_UNICODE_STRINGS_HPP
#define PHD_TESTS_BASIC_UNICODE_STRINGS_HPP

#include <string>
#include <memory>

namespace phd { namespace tests {
...
#endif // PHD_TESTS_BASIC_UNICODE_STRINGS_HPP
