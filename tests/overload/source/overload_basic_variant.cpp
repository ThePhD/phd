...
#include <phd/overload/tests/classes.hpp>
#include <phd/overload/tests/functions.hpp>
...
TEST_CASE("phd/overload/variant/free functions", "overload can handle non-template free functions with a variant") {
...
TEST_CASE("phd/overload/variant/lambdas", "overload can handle non-template lambdas with a variant") {
	SECTION("const") {
...
TEST_CASE("phd/overload/variant/member functions", "overload can handle member functions with a variant") {
	SECTION("value self") {
		auto ovr = phd::overload(
			&my_class::i_to_i,
			&my_class::s_to_i);
...
TEST_CASE("phd/overload/variant/virtual member functions", "overload can handle virtual member functions with a variant") {
	SECTION("value self") {
		auto ovr = phd::overload(
